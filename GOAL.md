...
Phases 0–6.12 are complete and integrated through `f627c2ab35d060cf402c5a539f062efd260111ba`, the source base for the historical Secure Engine 0.1.8 release candidate. Secure Engine 0.1.7 remains the published release. Phase 6.13 tranche 1 develops bounded forward scalar and exact static-property propagation from commit `189a20ea13b6803d24a444872762e178a928571d` without changing the candidate artifacts. Tranche 2 preserves the authorization boundary: generic collection/property mutations and arbitrary exports do not become protected sinks or handlers without an explicit domain contract. Tranche 3 recognizes only structurally fixed collection wrappers and binds exact outbound policy to the same URL or `href`. Taxonomy 1.0.0, Evidence Contract v2, secure-json-v1, SARIF, CLI/desktop parity, and disabled-by-default AI remain unchanged; development cache v16 treats v15 and older entries as safe misses. Mutable collection/spread round-trips, computed dispatch/properties, reflection, ambiguous imports/calls, implicit protected-operation semantics, recoverable-syntax expectations, and unproven runtime filesystem state remain intentional limits. No benchmark, ranking, superiority, production-readiness, corrected historical metric, or complete-coverage claim is supported.

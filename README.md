...
Secure Engine is the local Rust analysis core of the Secure project family. Public version 0.1.7 is based on the completed Phase 6.11 development line; the Phase 6.12 development tranches add bounded value-preserving summaries, exact shell program-text selection, derived guard/resource identity, and exact object-literal property/destructuring identity without changing that public version. The engine retains bounded local convergence independent of call depth, same-resource authorization, final dynamic sequence-expression callee resolution, composed filesystem path identity and confinement, constructed-redirect exact-origin reasoning, and outbound property/destructuring connectivity. The tool-neutral taxonomy 1.0.0, Evidence Contract v2, secure-json-v1, SARIF 2.1.0, rule IDs, CLI/desktop parity, baselines/history/suppressions, and disabled-by-default AI remain compatible; the private parse cache is v14.
...
Start with [GOAL.md](./GOAL.md), then read the full [PLAN.md](./PLAN.md). Phase 6.12 tranche 4 is documented in [docs/phase612-tranche4-object-literal-destructuring.md](./docs/phase612-tranche4-object-literal-destructuring.md), with the earlier tranches linked from its compatibility section. Phase 6.11 and the 0.1.7 candidate remain summarized in [docs/phase611-tranche3-root-cause-remediation.md](./docs/phase611-tranche3-root-cause-remediation.md) and [docs/release-notes-v0.1.7-rc1.md](./docs/release-notes-v0.1.7-rc1.md). The stable public projection remains documented in [docs/evidence-contract-v2.md](./docs/evidence-contract-v2.md). Fedora operations are documented in [docs/fedora-packaging.md](./docs/fedora-packaging.md); the published 0.1.6 verification remains frozen in [docs/verification-fedora-phase610.md](./docs/verification-fedora-phase610.md).
